...
public class EntityManager {
     ...
     * @return
     */
    public List<? extends Entity> query(boolean distinct, Class<? extends Entity> clazz,
                                        String[] columns,
        ...
        try {
            ...
            cursor = query(distinct, table, columns, selection, selectionArgs, groupBy, having,
                    orderBy, limit);
    ...
    private Cursor query(boolean distinct, String table, String[] columns, String selection,
        ...
        try {
            ...
            return db.query(distinct, table, columns, selection, selectionArgs, groupBy, having,
                    orderBy, limit);
        } catch (Exception e) {
            Logger.e("EntityManager.query() error, " + e, false);
            return null;
    ...
    private ContentValues createContentValue(Entity entity) throws IllegalArgumentException,
