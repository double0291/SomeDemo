package com.doublechen.androidtest.database;
...
import com.doublechen.androidtest.database.annotation.DefaultZero;
import com.doublechen.androidtest.database.annotation.NoColumn;
import com.doublechen.androidtest.database.annotation.Unique;
import com.doublechen.androidtest.database.annotation.UniqueConstraints;
...
public class TableBuilder {
    ...
    public static String createSQLStatement(Entity entity) {
        ...
        if (clazz.isAnnotationPresent(UniqueConstraints.class)) {
            UniqueConstraints constrains = (UniqueConstraints) clazz.getAnnotation
    ...
    public static List<Field> getValidField(Entity entity) {
        ...
        for (Field field : fields) {
            ...
            if (!Modifier.isStatic(field.getModifiers()) && !field.isAnnotationPresent(NoColumn
                    .class)) {
